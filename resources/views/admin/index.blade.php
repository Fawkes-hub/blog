	...
	<div class="top_box">
		...
		<div class="top_right">
			<ul>
				...
				<li><a href="{{url('admin\outlogin')}}">退出</a></li>
			</ul>
		</div>
	</div>
	<!--头部 结束-->
		...
		<ul>
            <li>
                ...
                <ul class="sub_menu">
					...
					<li><a href="{{url('admin\category\create ')}}" target="main"><i class="fa fa-fw fa-plus-square"></i>添加列表</a></li>

					<li><a href="{{url('admin\article')}}" target="main"><i class="fa fa-fw fa-list-alt"></i>文章列表</a></li>
