            ...
            <table class="add_tab">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="cate_name" value="{{$cate->cate_name}}" data-rule-required="true">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" class="lg" name="cate_title"  value="{{$cate->cate_title}}" data-rule-required="true">
